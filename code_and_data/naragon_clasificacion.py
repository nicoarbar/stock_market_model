...
for ticker in tickers_list:
	...
	#leemos los datos con solo la columna Adj Close
	...
	join_test_df_with_pred_array_to_csv(y_pred_knc, df_class_test, ticker, data_pred_dir, 'clasificacion_knc')
	join_test_df_with_pred_array_to_csv(y_pred_vc, df_class_test, ticker, data_pred_dir, 'clasificacion_vc')
	...
	model_scores_dict = {}
	model_scores_dict[ticker_simple + 'knc'] = accuracy_knc
	model_scores_dict[ticker_simple + 'voting_classifier'] = accuracy_vc
	mongo_scores.insert_in_mongodb(model_scores_dict)

	#se guarda el modelo en pickle con las fechas de entrenamiento
	save_model_in_pickle_object('{}/{}_clasificador_knc_simple_{}'.format(model_filename, ticker_simple, annomes_procesar_train), clasificador_knc)
	save_model_in_pickle_object('{}/{}_clasificador_vc_simple_{}'.format(model_filename, ticker_simple, annomes_procesar_train), clasificador_vc)